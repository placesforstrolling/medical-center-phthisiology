...
<section class="news">
  <div class="container">
    ...
    <div class="row">
    <?php 
include TEMPLATEPATH.'/phpQuery.php';
...
<div class="col-md-4">
        <div class="item">
          <div class="image">
            <img src="<?php echo bloginfo('template_url'); ?>/assets/img/ssv.png" style="height: 100%; width: auto; margin: auto;" alt="New">
          </div>
          <div class="item-body">
            <p class="date"> <?php 
                  echo $firstNew['date'];
      ...
      <div class="col-md-4">
        <div class="item">
          <div class="image">
            <img src="<?php echo bloginfo('template_url'); ?>/assets/img/ssv.png" alt="New" style="height: 100%; width: auto; margin: auto;">
          </div>
          <div class="item-body">
            <p class="date"> <?php 
                  echo $secondNew['date'];
